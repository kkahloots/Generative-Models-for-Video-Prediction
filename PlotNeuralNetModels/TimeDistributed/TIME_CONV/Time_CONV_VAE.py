...
arch = [
    ...
    #inferense logvar
    to_Conv("convb1", s_filer=246480, n_filer=10, offset="(0,-10.2,0)", to="(0,0,0)", height=35, depth=30, width=2 , caption="TimeDistConv2D"),
    to_Pool("poolb1", offset="(0,0,0)", to="(convb1-east)", height=3, depth=3),

    to_Conv("convb2",  7956, 10, offset="(1.5,0,0)", to="(convb1-east)", height=15, depth=10, width=2 ,caption="TimeDistConv2D"),
