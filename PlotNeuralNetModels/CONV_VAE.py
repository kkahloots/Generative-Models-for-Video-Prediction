...
arch = [
    ...
    to_SoftMax(name="flat1", s_filer= 8400 ,offset= "(1.25,0,0)", to = "(pool2-east)", caption="Flatten",
               height=20, depth=20, width=1),

    to_connection("pool2", "flat1"),

    to_Conv(name="dense1", s_filer=238710, n_filer=30, offset= "(1.25,0,0)", to="(flat1-east)", caption="dense1",
    ...
    #inferense logvar
    to_Conv("convb1", s_filer=100800, n_filer=300, offset="(0,-10.2,0)", to="(0,0,0)", height=45, depth=40, width=2 , caption="conv1"),
    ...
    to_SoftMax(name="flatb1", s_filer= 8400 ,offset= "(1.25,0,0)", to = "(poolb2-east)", caption="Flatten",
               height=20, depth=20, width=1),

    to_connection("poolb2", "flatb1"),

    to_Conv(name="denseb1", s_filer=238710, n_filer=30, offset= "(1.25,0,0)", to="(flatb1-east)", caption="dense1",
            height=19, depth=19, width=2),
